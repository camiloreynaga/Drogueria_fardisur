 ...
 * @package Reportico
 * @version $Id: swoutput.php,v 1.15 2012-05-08 21:01:14 root Exp $
 */
...
class reportico_report_html_template extends reportico_report
{
    ...
    function format_hyperlinks ( $hyperlinks, $padstring )
    {
        ...
        {
            $txt = '<a href="'.$hyperlinks["url"].'"'.$open.'>'.$padstring.'</a>';
        }
        else
            $txt = '<a href="'.$hyperlinks["url"].'"'.$open.'>'.$hyperlinks["label"].'</a>';
        return $txt;
    }
