 ...
 * @package Reportico
 * @version $Id: swgraph_pchart.php,v 1.2 2012-04-11 21:35:04 root Exp $
 */
...
class reportico_graph
{
	...
	{
		$this->width_pdf_actual = check_for_default("GraphWidthPDF", $this->width);
		$this->height_pdf_actual = check_for_default("GraphHeightPDF", $this->height);
