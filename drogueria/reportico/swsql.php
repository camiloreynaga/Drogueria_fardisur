 ...
 * @package Reportico
 * @version $Id: swsql.php,v 1.6 2012-01-17 21:33:37 root Exp $
 */
	...
	function  parse()
	{
		...
		if ( preg_match($sel_match, $sql, $cpt ) )
		{
			...
			if ( !preg_match($col_match, $rest, $cpt ) )
			{
				...
				trigger_error("No FROM clause specified or no WHERE clause specified. If no WHERE clause is requires use \"WHERE 1 = 1\" instead.", E_USER_ERROR);
			}
			else
			{
				$col = $cpt[1];
