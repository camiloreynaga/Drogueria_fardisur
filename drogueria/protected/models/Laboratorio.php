...
class Laboratorio extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('laboratorio', 'required'),
			array('id', 'numerical', 'integerOnly'=>true),
			array('laboratorio', 'length', 'max'=>50),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, laboratorio', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'productos' => array(self::HAS_MANY, 'Producto', 'laboratorio'),
		);
	}
	...
	public function search()
	{
		...
		return new CActiveDataProvider('Laboratorio', array(
			'criteria'=>$criteria,
		));
	}
}