...
class Detalle_ventaController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Detalle_venta');
	...
	{
		$model=new Detalle_venta('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Detalle_venta']))
			$model->attributes=$_GET['Detalle_venta'];
	...
	public function loadModel()
	{
		...
		{
			if(isset($_GET['id']))
				$this->_model=Detalle_venta::model()->findbyPk($_GET['id']);
			if($this->_model===null)
